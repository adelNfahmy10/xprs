...
export const MENU_ITEMS: MenuItemType[] = [
  ...
  //       key: 'allMobiles',
  //       label: 'All Mobiles',
  //       url: '/smartphone/mobile',
  //       parentKey: 'smartphone',
  //     },
  //     {
  //       key: 'samsung',
  //       label: 'Samsung',
  ...
  //       key: 'xiaomi',
  //       label: 'Xiaomi',
  //       url: '/smartphone/xiaomi',
  //       parentKey: 'smartphone',
  //     },
  //     {
  //       key: 'motorola',
  //       label: 'Motorola',
  //       url: '/smartphone/motorola',
  //       parentKey: 'smartphone',
  //     },
  //     {
  //       key: 'infinix',
  //       label: 'Infinix',
  //       url: '/smartphone/infinix',
  //       parentKey: 'smartphone',
  //     },
  //     {
  //       key: 'realme',
  //       label: 'Realme',
  //       url: '/smartphone/realme',
  //       parentKey: 'smartphone',
  //     },
  //     {
  //       key: 'mobileAccessories',
  ...
  //           key: 'mobileCase',
  //           label: 'Mobile Case',
  //           url: '/smartPhone/mobileAccessories/mobileCase',
  //           parentKey: 'smartPhone',
  //         },
  //         {
  //           key: 'privacyScreenShields',
  //           label: 'Privacy Screen Shields',
  //           url: '/smartPhone/mobileAccessories/privacyScreenShields',
  //           parentKey: 'smartPhone',
  //         },
  //         {
  //           key: 'cablesAdapters',
  //           label: 'Cables & Adapters',
  //           url: '/smartPhone/mobileAccessories/cablesAdapters',
  //           parentKey: 'smartPhone',
  //         },
  //         {
  //           key: 'adapterHubs',
  //           label: 'Adapter Hubs',
  //           url: '/smartPhone/mobileAccessories/adapterHubs',
  //           parentKey: 'smartPhone',
  //         },
  //       ]
  //     },
